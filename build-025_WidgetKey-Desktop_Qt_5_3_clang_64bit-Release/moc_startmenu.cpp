...
#include "../025_WidgetKey/startmenu.h"
...
QT_MOC_LITERAL(5, 29, 23),
QT_MOC_LITERAL(6, 53, 6)
    },
    "StartMenu\0setCurrent\0\0a\0Anim\0"
    "on_pushButton_6_clicked\0ptitle"
};
...
void StartMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (StartMenu::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StartMenu::setCurrent)) {
                *result = 0;
            }
        }
    }
...
int StartMenu::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QRect*>(_v) = title; break;
        default: break;
        }
        _id -= 1;
        ...
        switch (_id) {
        case 0:
            if (title != *reinterpret_cast< QRect*>(_v)) {
                title = *reinterpret_cast< QRect*>(_v);
            }
            break;
        default: break;
        }
...
// SIGNAL 0
void StartMenu::setCurrent(int _t1)
{
